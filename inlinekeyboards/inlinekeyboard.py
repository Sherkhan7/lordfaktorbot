...
class InlineKeyboard(object):
    ...
    @staticmethod
    def __get_services_keyboard(buttons, data):

        service_1_text = buttons[1]  # Smm
        service_1_emoji = '\U0001F4E2'

        service_2_text = buttons[2]  # Telegram bot
        service_2_emoji = '\U0001F916'

        service_3_text = buttons[3]  # Web
        service_3_emoji = '\U0001F310'

        service_4_text = buttons[4]  # Mobile app
